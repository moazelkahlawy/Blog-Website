...
const Banner = () => {
  return (
    <div className="block md:flex md:space-x-2 px-2 lg:p-0">
      <a className="mb-4 md:mb-0 w-full md:w-2/3 relative rounded inline-block" style={{ height: "24em" }} href="#">
        <div
      ...
      <a className="w-full md:w-1/3 relative rounded" style={{ height: "24em" }} href="#">
        <div
